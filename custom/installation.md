...
2. Importing the .unitypackage which you can download [here](https://github.com/liquiidio/EosSharp-Private/releases/download/1.0.1/io.liquiid.eossharp.unitypackage). (TODO! Get final URL)
...
Download the [UnityPackage here](https://github.com/liquiidio/EosSharp-Private/releases/download/1.0.1/io.liquiid.eossharp.unitypackage). (TODO! Get final URL)
