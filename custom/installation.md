...
2. Importing the .unitypackage which you can download [here](https://github.com/liquiidio/HyperionApiClient-Private/releases/download/1.0.3/io.liquiid.hyperion.unitypackage). (TODO! Get final URL)
...
Download the [UnityPackage here](https://github.com/liquiidio/HyperionApiClient-Private/releases/download/1.0.3/io.liquiid.hyperion.unitypackage). (TODO! Get final URL)
