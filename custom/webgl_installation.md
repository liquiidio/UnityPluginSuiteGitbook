...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL AnchorLink Canvas</title>
  ...
  <body>
    <div id="unity-container" class="unity-desktop">
      ...
      <div id="unity-footer">
        ...
        <div id="unity-build-title">Unity WebGL AnchorLink Canvas</div>
      </div>
    </div>
    <script>
      ...
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Anchor Canvas WebGL 2021.x.loader.js";
      var config = {
        dataUrl: buildUrl + "/Anchor Canvas WebGL 2021.x.data.gz",
        frameworkUrl: buildUrl + "/Anchor Canvas WebGL 2021.x.framework.js.gz",
        codeUrl: buildUrl + "/Anchor Canvas WebGL 2021.x.wasm.gz",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "UnityPluginSuiteUnity",
        productVersion: "0.1",
