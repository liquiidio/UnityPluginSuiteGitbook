# class `AtomicMarketApiClient::Auctions::AuctionDto::DataDto::AssetDto` 
...
`public ` [`CollectionDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--CollectionDto.md)` ` [`Collection`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ac6d9b0c1cef1d8ad020fa9b6fc1c3319) | The Collection this belongs to.
`public ` [`SchemaDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--SchemaDto.md)` ` [`Schema`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ad93c55d7b2a8254b86543bda80750a31) | The Schema this belongs to.
`public ` [`TemplateDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--TemplateDto.md)` ` [`Template`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1a8d65cc2a5ff793ff3eb7a51b7d72e43f) | The Template this belongs to.
...
`public ` [`BackedTokensDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--BackedTokensDto.md)` ` [`BackedTokens`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ace4511d1490d9905e3f19026c18dbc96) | Tokens by which this Asset is backed.
...
##### `public ` [`CollectionDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--CollectionDto.md)` ` [`Collection`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ac6d9b0c1cef1d8ad020fa9b6fc1c3319) 

The Collection this belongs to.

##### `public ` [`SchemaDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--SchemaDto.md)` ` [`Schema`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ad93c55d7b2a8254b86543bda80750a31) 

The Schema this belongs to.

##### `public ` [`TemplateDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--TemplateDto.md)` ` [`Template`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1a8d65cc2a5ff793ff3eb7a51b7d72e43f) 
...
##### `public ` [`BackedTokensDto`](AtomicMarketApiClient--Auctions--AuctionDto--DataDto--AssetDto--BackedTokensDto.md)` ` [`BackedTokens`](#class_atomic_market_api_client_1_1_auctions_1_1_auction_dto_1_1_data_dto_1_1_asset_dto_1ace4511d1490d9905e3f19026c18dbc96) 
